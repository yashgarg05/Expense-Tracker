...
import { Search, Edit2, Trash2, Filter, Inbox } from 'lucide-react';
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            onClick={() => onDelete(tx)}
                            className="p-1.5 rounded-md text-muted-foreground hover:bg-rose-500/10 hover:text-rose-600 dark:hover:text-rose-400 transition-colors"

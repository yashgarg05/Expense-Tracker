    ...
    <div className="max-w-4xl space-y-8 select-none">
      ...
      <div className="rounded-xl border border-border bg-card p-6 shadow-2xs space-y-4">
        ...
        <form onSubmit={handleSaveProfile} className="space-y-4 text-xs">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-sm border border-primary/20">
              YG
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-input bg-background px-3 py-2 text-xs text-foreground outline-none focus:border-ring focus:ring-1 focus:ring-ring"
              />
            </div>
            <div className="space-y-1">
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-2xs space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            <button
              ...
              className={cn(
                'flex flex-col items-center justify-center gap-2 p-3 rounded-lg border text-center transition-all',
                theme === 'light'
      ...
      {showClearConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative z-50 w-full max-w-sm rounded-xl border border-border bg-card p-6 shadow-2xl space-y-5 text-foreground select-none">
